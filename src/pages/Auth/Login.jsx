        ...
        <div className="w-full max-w-md bg-[#D9E4C7] rounded-lg shadow-lg flex overflow-hidden">
          ...
          <div className="p-8 w-1/2">
            ...
            <div className="text-center text-sm text-gray-500 mt-4">
              belum punya akun? <a href="#" className="font-bold text-black hover:underline">Register</a>
            </div>
          </div>
  
          {/* Right side (Background image) */}
          <div className="w-1/2 bg-cover" style={{ backgroundImage: "url('/path/to/background-image.jpg')" }}>
